...
//
// adb shell am start -a android.intent.action.SEND -t image/jpeg --es android.intent.extra.STREAM file:///sdcard/test.txt  com.example.introductory.introductory
// adb shell am start -a android.intent.action.SEND -t image/jpeg --es android.intent.extra.STREAM file:///data/data/com.example.introductory.introductory/shared_prefs/main_data.xml  com.example.introductory.introductory
//
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEND.equals(action) && type != null && type.startsWith("image/jpeg")) {
